  ...
  var sections = [
    <section>
      ...
      <p>
        ...
        no empezaba a trabajar hasta la tarde, entonces solías dormir durante todo ese tiempo hasta que te despertaba, a menudo
      ...
      <p>—¿Crema? —pregunta Whitby e interrumpe tus pensamientos. Niegas con la cabeza.</p>
      <p>—Intento dejarla. Aunque sí acepto un montón de azúcar.</p>
      <p>
      ...
      <p>—¿Por qué volviste a Nueva Jersey? —Cuando luces confundido, dice—: Después de que murió tu mamá. Era dueña de esa propiedad,
      así que seguro vale mucho, justo ahí en el paseo marítimo. —Se sienta en frente tuyo y entrelaza las manos con delicadeza.</p>
      <p>—¿Revisaste mis antecedentes? —Se encoje de hombros: <em>Eso es lo que hago</em>—. Volví a casa
        cuando ella estaba en el hospital, pensé que manejaría las cosas un tiempo hasta que se recuperara. —Pausas, le das un sorbo al café,
        agregas más azúcar—. Nunca pasó. Todavía no encontré el tiempo para venderlo.</p>
      <p>—Eso fue hace cuatro años. —Lógicamente sabes esto, pero es diferente cuando alguien más lo dice en voz alta.
      Antes de poder responder, dice—: Perdón, no me incumbe saber por qué.</p>
      <p>Vacilas y luego dices:</p>
      <p>—No siempre existe un porqué. A veces las personas solo quedan... estancadas. —Asiente y levanta una pequeña pila de fotos
      y empieza a exponerlas con cuidado hacia abajo. Sería una excelente crupier—. ¿Otra prueba? —suspiras.</p>
    ...
    <section>
      ...
      <p>
        ...
        Intenté rastrearla; me dejó un mensaje en la oficina donde decía que había conocido a alguien más y que
        no la buscara. No estaba de acuerdo, pero ¿quién soy yo para juzgarla?
      </p>
      <p>—¿Cómo lo tomó su esposo?</p>
      <p>—Como te lo imaginas. Así que ha estado criando a su hija solo. Es un buen padre soltero, pero la clase que cree que se merece
        una medalla por hacer lo que millones de mujeres hacen cada año. —Da vuelta otra <List expansions={["foto", "foto de Sarah, la niña con la muñeca"]} tag="c1_photos2"/>.
      </p>
    </section>,
    <section>
      <p>—Esta foto es de hace unos años, ya tiene once. —Whitby la considera un momento—. Todos aman a esa pequeña. No solo porque
        su mamá la abandonó, sino porque simplemente es una chica dulce. —Da vuelta <List expansions={["otra foto", "una foto de dos gemelos adultos"]} tag="c1_photos3" />.</p>
    </section>,
    <section>
      <p>—Michael y Michelle Herschel —dice y no puedes evitar resoplar—. Sí, cero puntos por
        ...
        Alan y Jared, pero falleció hace unos años. Los gemelos aún viven en su casa en Sea Isle. No los conozco personalmente.</p>
    ...
    <section>
      ...
      <p>—Ella no lo mató —dices y te sorprendes a ti mismo—. Vi como lo miraba la noche que murió. Estaba preocupada por él. Lo amaba.</p>
      <p>
      ...
      <p>Le suena el teléfono antes de poder responder. Whitby escucha y asiente un par de veces, luego tapa el auricular.</p>
        <p>—Debo atender esto. ¿Puedes esperar afuera?</p>
      <p>Desterrado, te escabulles a través de la comisaría hacia una sala de espera cercana. Seis sillas de plástico, algunos otros hombres.
        Aquí no es el ingreso general, ese estaría infestado de gente impaciente y borracha, enojada o, lo que es más probable, ambos.
        Aquí es donde ponen a las visitas que vinieron por voluntad propia, los que vienen a hablar con los detectives.</p>
      <p>Nadie luce contento de estar aquí, y honestamente no te gustaría compartir una cerveza con ninguno, pero al menos estas personas no están vomitando.
      ...
      <p>
        ...
        cuando una mujer empieza a discutir con un joven oficial impasible:</p>
        <p>—¡Pero la detective Whitby me dijo específicamente que viniera ahora!</p>
        <p>Levantas la vista y, con sorpresa,
        reconoces a la sobrina mayor de Healey, Michelle, de la foto. Le dicen que se calme y espere sentada. Ella se sienta
        en frente tuyo en una de las pocas sillas vacías.</p>
    ...
    <section>
      ...
      <p>No responde. ¿Quién puede culparla? Eres un extraño raro que le habla en una comisaría.</p>
        <p><Map from={inventory.c3_staring} to={{
          manos: `—Aquí tiene —dices y le pasas una toallita de mano que te robaste de la oficina de Whitby—. Para cuando se vaya. Solo hay un baño y no tiene jabón`,
          zapatos: `Finges intentar ponerte cómodo en el asiento.</p>
          <p>—Dios, ¿todo el día trabajando y ahora estas sillas? Estoy listo para confesar lo que sea`,
          bolso: ` —Lamento molestarla —continúas—, pero ¿tiene un pañuelo? —Las mujeres siempre tienen pañuelos en el bolso—. Debe haber moho
          acá o algo, mi alergia me está matando
          `
        }}/>.
      </p>
      <p><Map from={inventory.c3_staring} to={{
    ...
    <section>
      ...
      <p>
        ...
        El motociclista le murmura algo.</p>
        <p>—Déjela tranquilo, amigo —le adviertes y parece ofendido, ¿no estaban del mismo lado?</p>
      <p>—Perdón —dice la señora Herschel de repente—. Fui maleducada con usted.</p>
      <p>—No hace falta disculparse. —<em>Además, intento robarte el bolso.</em></p>
      <p>—Soy Michelle.</p>
      <p>—Frank —contestas—. Frank Desiderio. Ese era el apellido de tu padre. Nunca fue el tuyo.</p>
      <p>—¿Y a qué te dedicas, Frank?</p>
      <p>No está verdaderamente interesada, solo está siendo educada y
      ...
      <p>—Conductor de limusinas —respondes. Eso también es verdad. Tienes algunos autos que le estás subarrendando a un amigo por el momento.
        Sigues pensando que venderás la propiedad de mamá, comenzarás tu negocio de nuevo, pero nunca es el momento adecuado—. Paga bien.
        Siempre hay ricos tontos para trasladar a los casinos de Filadelfia o Nueva York.</p>
      <p>Demasiado tarde recuerdas que <em>ella</em> es rica. O por lo menos su familia. Es curioso como eso no implica siempre lo mismo.</p>
        <p>—¿Y tú? —preguntas, con la esperanza de cambiar de tema.</p>
      <p>—Trabajo con mi hermano —dice y te das cuenta que terminó la conversación. Cierra el bolso y, angustiosamente, lo deja del otro lado.
      Sientes alivio de lo que sea que ha intentado evitarte.</p>
      <p>Whitby entra a la sala de espera y te roza al pasar de manera tan brusca que sabes que es una señal deliberada.</p>
        <p>—Señora Herschel —dice, se agacha en frente de la mujer y se le acerca como una confidente—. Lamento haberla hecho esperar.</p>
      <p>—Está bien, solo estoy un poco apurada...</p>
      <p>Interrumpes en voz alta.</p>
      <p>—Oiga, señorita policía, llegué primero y he estado esperando más de una hora. —La cara de Whitby no muestra señales de reconocerte.</p>
      <p>—Señor, si me dice qué necesita, puedo intentar encontrar a alguien...</p>
      <p>—Lo que <em>necesito</em> es que alguien me ayude aunque no tenga una cara bonita ni un <em>bolso</em>.</p>
      <p>—Señor, debo pedirle que se calme. —Whitby abraza a Michelle Herschel de manera protectora y la levanta. Al hacerlo,
      ...
      <p>»Lo siento mucho —le dice Whitby a Herschel y se agacha para ayudarla a limpiar.
      <Map from={inventory.c3_receipt} to={{
    ...
    <section>
      ...
      }} /> del piso y se lo ofreces a Herschel, pero se aleja de ti.</p>
      <p>—Sabía que eras un pervertido —dice y sale corriendo de la habitación hacia la oficina de la detective.
      Whitby te mira con compasión y asientes ligeramente: <em>Conseguí lo que quería</em>.</p>
