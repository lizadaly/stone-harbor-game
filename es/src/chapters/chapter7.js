...
const _Chapter = ({currentSection, inventory, chapterId}) => {
  var sections = [
    <section>
      ...
      <p>
        Te abre un hombre. Es gigantesco. No se ve sorprendido, pero tú sí lo estás.
        </p><p>―Sí, soy blanco ―dice. Antes de que puedas decir algo más estúpido de lo que tu cara muestra, Hank te deja pasar―. ¡Tamisha, llegó tu vidente!
      ...
      <p>
        ...
        hasta llegar a la cocina comedor. En la mesa te espera un plato de espagueti―. Come ―dice.
      </p>
      <p>
        ―¿Qué te hace pensar que aún no comí?
      </p>
      <p>
        Descorcha el vino y te sirve un poco en un frasco.
        </p><p>―He visto tu refrigerador.
        </p><p>Comienzas a protestar, pero Hank el Tanque te está mirando, así que solo tomas el tenedor.
      ...
      <p>
        ...
        pero ni él ni su hermana han ido en días. ―Completas la historia sobre Jared entre cada bocado de
        espagueti―. Es extraño, ¿no? ―dice― ¿Por qué iría a ti?
      </p>
      <p>
        ...
        </p><p>―Dijo algo sobre que su esposa me mencionó. Supongo que se refería a mi madre.
      </p>
      <p>
      ―A Ally le gustaba toda esa mierda cuando era pequeña, perdón por la expresión. ―Le pides que continúe con un gesto magnánimo―. ¿Tal vez se le pegó a su esposo?
      </p>
      <p>
      Te levantas, lavas tu plato y vuelves a sentarte en la mesa. Sacas la alianza del bolsillo
      y abres la servilleta que lo envolvía.
      </p><p>―Me dio esto cuando le pedí algo personal.
      </p>
      <p>
      ...
      <p>
        Está preocupada por ti y quiere demostrártelo.
        </p><p>―Te pedí que vinieras porque sonaba a que necesitabas compañía.
        Además, Hank volvió a hacer demasiado espagueti. ―Te toca el brazo―. Estamos aquí para ti. No soy ninguna vidente, pero estamos cerca de descifrarlo. Lo sé.
      </p>
      <p>
        ―Espero que tengas razón ―dices― porque esto me está matando.
        </p><p>Antes de que te responda, agarras el <List expansions={["anillo", "anillo nervioso y contrito"]} tag="c7_ring" />.
      </p>
    </section>,
    <div className="in-flashback">
      ...
      <section>
        ...
        <p>
          ...
          mientras que su hermano crea círculos en la arena de tanto ir de aquí para allá.
          </p><p>―Ya lo he decidido.
        </p>
        <p>
        ...
        <p>Jared no sabía esto.
        </p><p>―¡No es tu hija! ¿Cómo te atreves?</p>
        <p>―Como vas encaminado, Jared, no quedará <em>nada</em> para ella. Tendrá suerte si no es
        huérfana para el momento en que tus planes lleguen a su fin. ―Se le suaviza un poco la voz―. Estas
        personas son <em>peligrosas</em>. Son asesinos.
        </p>
        <p>
          ―Son mis amigos. Jamás...
        </p>
        <p>
          ―Lo harán. No puedo evitar que arruines tu vida, pero sí puedo evitar que arruines la de tu hija. ―Observa
          el mar para esquivar la mirada de su hermano―. Decidí vender todo el negocio,
          liquidar los bienes inmuebles. Todo irá para Sarah y Maggie.
        </p>
        <p>
          El horror en la cara de Jared indica que esto no es algo bueno para él.
          </p><p>―Nunca podremos saldar lo que debemos. Michael me matará.
        </p>
        <p>
          Alan niega triste con la cabeza.
          </p><p>―Michael tendrá que encaminarse de vuelta solo. No sé cuándo esta familia se desvirtuó tanto,
    ...
    <section>
      ...
      <p>
        Healey se aleja, pero tu madre le agarra las muñecas, sus ojos todavía ven a la nada horrorizados.
        </p><p>―Escúchame, Allison.
      </p>
      <p>
        ―Yo no... Suéltame...
        </p>
      <p>
        ―Jared te traicionará. Si te quedas con él, tú y tu hija morirán ―Healey se queda dura e inmóvil―. Todavía no te lo dijo, pero está endeudado.
         No es nada serio, apuesta en los juegos de los domingos con sus amigos.
        Sabe que su hermano lo ayudará si se mete en problemas. Habla con apuro:
      </p>
      <p>
        »Pero no se detendrá. Lo envenenará poco a poco. Les dará trabajo a esos amigos para tapar las pérdidas
      ...
      <p>
        ...
        Te encuentran, en un motel, en un semáforo. No importa lo que hagas, siempre la encuentran. ―Allison llora desconsoladamente, como si ella misma lo estuviera viendo. Tu madre asiente―. Existe una forma. Una única forma. Si te vas, pensarán que solo lo abandonaste, que te asqueó su conducta.
      ...
      <p>
        ...
        </p><p>―Algún día, volverás a ver a tu hija otra vez. Cuando lo hagas, te perdonará por haberte ido.
      </p>
      <p>
    ...
    <section>
      ...
      <p>
        ―¿Dónde está Sarah? ―dices antes de siquiera volver del todo al presente―. Siempre se trató de Sarah. Está en peligro.
      </p>
      <p>
        Hay que reconocer que Whitby no pierde tiempo en preguntas.
        </p><p>―Asumí que estaba con su padre.
        </p><p>Se levanta para hacer una llamada y te quedas solo con Hank. Deberías sentirte incómodo, pero, en vez de eso,
