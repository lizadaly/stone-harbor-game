...
const _Prologue = ({currentSection, inventory}) => {
  ...
  var sections = [
    <section>
      ...
      <p>—¿Viniste por una lectura? —preguntas de manera solemne. El cliente asiente—. Entonces comencemos.
      Algunos contactan a los espíritus con cartas o las palmas. Yo requiero un objeto personal, uno infundido con el espíritu mismo.
      </p>
      <p>Inspeccionas al cliente, que tiene <List expansions={Customer.clothes} conjunction="y" tag="p0_customer_clothes"/>.</p>
    </section>,
    <section>
      <p>
        —Siento una poderosa fuerza psíquica de tu <FromInventory inventory={inventory.p0_customer_clothes} offset={1} /> —dices—. ¿Puedes dármelo? —El cliente mira asombrado cuando te lo entrega.
        Cierras los ojos y giras el <FromInventory inventory={inventory.p0_customer_clothes} offset={1} /> lentamente entre tus manos—. <Map from={inventory.p0_customer_clothes} to={mapsClothes} offset={1}/>. —Frunces el ceño—. Los espíritus quieren ayudar,
        pero las señales son débiles... —Cuando no responde, abres un ojo y te aclaras la garganta. Rápidamente saca otros veinte dólares.
      </p>
      <p>
        —Veo un nombre —continúas—. Comienza con una S... —te mira inexpresivo—. ¿O una N? —Reacciona.
        Frunces el ceño como en profunda concentración—. <List expansions={Customer.names} tag="p0_customer_names"/>
      </p>
    </section>,
    <section>
      ...
      <p>—El más allá cambia a las personas —dices ignorando su objeción. Analizas <List expansions={Customer.body} tag="p0_customer_body" conjunction="y" />.</p>
    </section>,
    <section>
      ...
      <p>Casi salta del asiento y guarda todo apurado, con vergüenza.</p>
      <p>—No tienes que irte —le dices—, pero es inútil, ya no te cree nada.</p>
      <p>Trata de salir mientras la mujer, la oficial de policía, lo mira con una mezcla de pena y
        desdén. Está tan apurado que se olvida de llevarse el dinero extra de la mesa
      ...
      <p>—¿Puedo ayudarla, oficial? —preguntas. Y luego dice algo que ni tú podrías haber predicho.</p>
    ...
    <section>
      <hr/>
      <p>Esperas que corte el momento pesado con un chiste, pero no, solo se queda analizándote. Puedes ser un fraude, pero no eres grosero.</p>
      <p>—Frank Pietro —dices y extiendes tu mano rechoncha. Te saluda y saca una de tus tarjetas de negocios.</p>
      <p>—¿No "El Gran Francisco"?</p>
      <p>Te encoges de hombros y apuntas al cartel sobre la puerta: “<small>Solo para entretenimiento</small>.” Ambos se sientan. Ella dice:</p>
      <p>—No creo en la clarividencia o en los psíquicos o en nada de eso. Vine aquí como un favor a una persona. —Te mira fijo, demasiado, y no puedes evitar
      retorcerte un poco de vergüenza. Así se deben sentir tus clientes—. Alguien murió hace un mes, en Stone Harbor, un anciano llamado Alan Healey.
      Puede que lo hayas visto; estuvo en el periódico.</p>

      <p>—Es verano en el paseo marítimo —contestas—. He estado bastante ocupado con el trabajo.</p>
      <p>Mira intencionadamente la sala de lectura y no necesitas ser vidente para saber lo que opina de tu carrera. Saca una carpeta y comienza a leerla.</p>
        <p>—Healey fue encontrado muerto en su casa después de ingerir una sobredosis de su remedio para la presión arterial. Los Healey son
        una familia antigua y adinerada del pueblo, así que la historia apareció bastante en las noticias.</p>
      <p>
        Stone Harbor es un hermoso pueblo próspero y autosuficiente a quince minutos y un millón
        de kilómetros de distancia del pueblo carnaval de clase media donde vives.</p>
        <p>—Perdón, ¿qué tiene que ver esto conmigo?</p>
      <p>—Healey tiene una sobrinita que vivía con él. Ella es mi ahijada. Su madre ya no está, pero sé que ella...
      Yo siento... —Luce incómoda, como muchos de tus clientes al principio—. Es una persona muy... espiritual.
      Cree fácilmente. —Whitby pausa de nuevo.</p>
      <p>—Quiere decir que es ingenua —dices. La detective frunce el ceño.</p>
      <p>—Yo no quiero estar aquí y tú quieres que me vaya. Era un anciano que no veía bien y leyó mal su dosis, pero le estoy haciendo el favor
        a una vieja amiga y... —Mete la mano en el bolsillo, en busca de algo—. Allison, mi amiga, me dijo que si algo violento pasaba en la familia,
        si había alguna razón para pensar que su hija estaba en peligro, que debía venir a ver a la vidente de aquí. Que ella la había escuchado y podría ayudar...
      </p>
      <p>—Claro, <em>ella</em> —exclamas—. Mi madre era "La Gran Francesca". Este era su negocio, pero murió.</p>
      <p>—Lo siento, no quise... —Tú también estás enojado, pero no sabes por qué.</p>
        <p>—Y ahora yo lo manejo. Para turistas e inocentes. <i>Solo para entretenimiento</i>.</p>
      <p>—Sabía que era una pérdida de tiempo —dice Whitby. Arroja un <List expansions={["guante de cuero", "<psychic>guante tenso y furioso</psychic>"]} tag="p0_glove"/> sobre la mesa—. Ahí tienes,
    ...
    <section>
      ...
      <p>
        Le devuelves el guante.</p>
        <p>—Healey fue asesinado.
      </p>
