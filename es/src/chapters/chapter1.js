...
const _Chapter = ({currentSection, inventory, chapterId}) => {
  ...
  var sections = [
    <section>
      ...
      <p>—Háblame de nuevo sobre la <FromInventory inventory={inventory.p0_library_things} offset={1} />. ¿Qué viste exactamente? —Te remites a los hechos.</p>
      <p><Map from={inventory.p0_library_things} to={libraryMaps} offset={1} /></p>
      <p>La detective no responde de inmediato, solo anota lo que dijiste.</p>
      <p>—Y describe la habitación de nuevo.</p>
      <p>—Ya te dije...</p>
      <p>—De nuevo. —No te mira a los ojos y, si intentaras leerla, no obtendrías ninguna pista. Es buena. Lo que es curioso, sin embargo,
      es que estás diciendo la verdad.</p>
      ...
      <p>—No puedo. —Te mira.</p>
      <p>—Viste la <FromInventory inventory={inventory.p0_library_things} offset={1} /> claramente, pero ¿no recuerdas nada sobre
      ...
      <p>¿Cómo explicarlo? Fue como mirar por el lado equivocado de un telescopio. El escritorio, ese
        ...
        que se oscurece y todo el mundo se va desmoronando. Pero solo dices, sin convicción:</p>
      <p>—Era difícil ver.</p>
      <p>Está escribiendo de nuevo, durante mucho tiempo. Intentas beber tu café, pero se enfrió y toda esa crema es nauseabunda.</p>
      <p>—¿Qué sientes con esto? —dice sin levantar la mirada. Pone <List expansions={["un reloj de hombre", "un reloj de oro común"]} tag="c1_watch" /> sobre la mesa.</p>
    </section>,
    <section>
      <p>Lo levantas un momento y lo sueltas de nuevo.</p>
      <p>—Es un reloj. ¿Quieres saber si es falso? No tengo idea. —No responde, solo sigue rayando ese maldito cuaderno.</p>
      <p>—¿Y esto? —Saca un <List expansions={["pañuelo", "pañuelo, cubierto de manchas rojo oscuro, que te generan aversión cuando lo das vuelta"]} tag="c1_handerchief" />.
      </p>
    </section>,
    <section>
      <p>—Dios mío, ¿eso es sangre? —Por instinto, intentas alejarte de la mesa, pero estás en una mesa cerrada, no hay escapatoria.</p>
      <p>—¿Sientes algo? —pregunta sin gracia, como si sorprender a la gente con evidencia sangrienta fuera lo más común del mundo.
      Quizás los policías hacen esto para divertirse.</p>
      <p>—¡No! ¿Qué rayos te pasa?</p>
      <p>—El reloj era de mi ex. El pañuelo lo compré de camino aquí y lo manché con kétchup mientras estabas en el baño. —Te mira directo a los ojos.
      El estómago aún te da vueltas.</p>
      <p>—Porque crees que soy un fraude.</p>
      <p>—Claro que lo eres.</p>
      <p>No está equivocada, pero te sientes herido y avergonzado. Ella suspira y dice:</p>
      <p>—Todo lo que describiste sobre esa habitación es correcto. Quizás lo sabías porque eres el asesino. Quizás eres... otra cosa.
      Pero no mentías y sospecho que eso te sorprendió como a cualquiera.</p>
      <p>Antes de poder reaccionar a esa extraordinaria declaración, dice:</p>

      <p>—Probemos con esto ahora. —Te arroja <List expansions={["un pequeño objeto metálico.", "<psychic>un frustrado aparato para cortar</psychic>.", "una herramienta metálica para cortar que emana frustración y en cuanto la atrapas estás...<br/><br/><br/>"]} tag="c1_device" />
      </p>
    </section>,
    ...
    <section>
      ...
      <p>
        —Está bien —le dice Whitby a la gente. Intenta sacar el cortapuros de tu puño cerrado.
        Su mano se siente caliente como el fuego contra tu piel, pero tú eres el que está frío.</p>
      <p>—¿Qué hice? —susurras e intentas sentarte derecho.</p>
      <p>—Empalideciste y luego te desplomaste. —Ves que tu café se volcó y hay una pila de servilletas empapadas cerca del salero.</p>
      <p>—Perdón —murmuras. Los clientes de la cafetería volvieron a fingir que no notaron nada. Le clavas los ojos a la detective con tu mejor mirada
      de vidente—. Encontraste <List expansions={["ese objeto", "el cortapuros de Healey", "el cortapuros de Healey, en una urna", "el cortapuros de Healey, en una urna, olvidado por el asesino"]} tag="c1_face" /> detrás
      ...
      <section>
        ...
        <p>—Eso creemos. Fumaba afuera, pero guardaba los cigarros en ese estudio. Encontramos uno desenvuelto, pero sin cortar. —Pausa y baja la voz—. ¿Dónde estabas? ¿Recién?</p>
        <p>—Detrás de su casa. Vi cuando llegaba la policía, la mañana de la muerte de Healey.</p>
        <p>—¿Y la urna? —pregunta. Ya que estamos en el baile, bailemos.</p>
        <p>—Pude sentirlo. El cortapuros... lo extraña.</p>
        <p>—¿Lo qué? —Te sudan las palmas, pero ya se usaron todas las servilletas para limpiar el café. Te secas con tus pantalones.</p>
          <p>—No creo poder... conectarme con cualquier objeto. Tiene que estar comprometido con lo que sucedió.</p>
        <p>—Comprometido —repite.</p>
        <p>—Déjame ver el guante de nuevo. —Lo saca con renuencia. Como esperabas, ya no está bañado en ira o venganza o ninguna emoción—.
        Cuando lo sostuve por primera vez —explicas—, era como estar en la habitación con la persona más enojada que existe. Alguien
          tan cegado por la furia que no quería otro resultado más que violencia.</p>
        <p>Arquea la ceja de manera espectacular.</p>
        <p>—El guante. Estaba enojado.</p>
        <p>—Y este cortapuros —continúas—, solo quería cortar un cigarro más. Su existencia tenía un propósito y ese propósito fue frustrado.</p>
        <p>—¿Y ahora? ¿Este cortapuros lo <em>extraña</em>?</p>
        <p>—Ya no. Creo que una vez que... me muestran lo que sienten, quedan satisfechos. —Ella se reclina y cruza los brazos.</p>
        <p>—Señor Pietro, no logro darme cuenta, ¿crees que soy idiota o demasiado inocente?</p>
        <p>—Ese guante —señalas—. Solo encontraste uno, ¿no?</p>
        <p>—Sí —dice desconfiada.</p>
        <p>
